### Deprecated
There is a new, improved version available. Check it out on [mmenujs.com](https://mmenujs.com)
...
Need help? Have a look at [the documentation](https://mmenu.frebsite.nl) for demos, tutorials, documentation and support.<br />
Working on a WordPress site? Check out [the mmenu WordPress plugin](https://mmenujs.com/wordpress-plugin).

<img src="https://mmenu.frebsite.nl/img/preview-3.png" alt="jQuery mmenu" width="100%" />

### Licence
The jQuery.mmenu plugin is licensed under the [CC-BY-NC-4.0 license](http://creativecommons.org/licenses/by-nc/4.0/).<br />
You can [purchase a license](https://mmenu.frebsite.nl/download.html) if you want to use it in a commercial project.

### Dependencies
+ jQuery 1.7 or higher

### Learn more
+ [Tutorial](https://mmenu.frebsite.nl/tutorials/off-canvas/)
+ [Options](https://mmenu.frebsite.nl/documentation/core/options.html)
+ [Extensions](https://mmenu.frebsite.nl/documentation/extensions/)
+ [Add-ons](https://mmenu.frebsite.nl/documentation/addons/)
+ [API](https://mmenu.frebsite.nl/documentation/core/api.html)
