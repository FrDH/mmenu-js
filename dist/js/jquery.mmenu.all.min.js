 ...
 * Copyright (c) Fred Heusschen
 */
function(e){function n(n,t){n||(n=this.$pnls.children("."+a.current));var s=e();"default"==t&&(s=n.children("."+a.listview).find("a[href]").not(":hidden"),s.length||(s=n.find(d).not(":hidden")),s.length||(s=this.$menu.children("."+a.navbar).find(d).not(":hidden"))),s.length||(s=this.$menu.children("."+a.tabstart)),s.first().focus()}function t(e){e||(e=this.$pnls.children("."+a.current));var n=this.$pnls.children("."+a.panel),t=n.not(e);t.find(d).attr("tabindex",-1),e.find(d).attr("tabindex",0),e.find("input.mm-toggle, input.mm-check, a[href]."+a.title).attr("tabindex",-1)}var s="mmenu",i="keyboardNavigation";e[s].addons[i]={setup:function(){var o=this,r=this.opts[i];this.conf[i];l=e[s].glbl,"boolean"!=typeof r&&"string"!=typeof r||(r={enable:r}),"object"!=typeof r&&(r={}),r=this.opts[i]=e.extend(!0,{},e[s].defaults[i],r),r.trigger&&e(r.trigger).addClass(a.trigger),r.enable&&(r.enhance&&this.$menu.addClass(a.keyboardfocus),this.bind("initPanels",function(){this.$menu.find(d).first().addClass(a.tabstart),e("."+a.panels+" > ."+a.panel).each(function(){e(this).find(d).last().addClass(a.tabend)})}),this.bind("open",function(){t.call(this),this.__transitionend(this.$menu,function(){n.call(o,null,r.enable)},this.conf.transitionDuration)}),this.bind("openPanel",function(e){t.call(this,e),this.__transitionend(e,function(){n.call(o,e,r.enable)},this.conf.transitionDuration)}),this["_initWindow_"+i](r.enhance))},add:function(){a=e[s]._c,o=e[s]._d,r=e[s]._e,a.add("tabstart tabend keyboardfocus trigger"),r.add("keydown focusout")},clickAnchor:function(e,n){}},e[s].defaults[i]={enable:!1,enhance:!1},e[s].configuration[i]={},e[s].prototype["_initWindow_"+i]=function(n){l.$wndw.off(r.keydown+"-offCanvas"),l.$wndw.off(r.focusout+"-"+i).on(r.focusout+"-"+i,function(n){var t=e(n.target);l.$html.hasClass(a.opened)&&t.is("."+a.trigger)&&e("."+a.tabstart).focus()}),l.$wndw.off(r.keydown+"-"+i).on(r.keydown+"-"+i,function(n){var t=e(n.target),s=t.closest("."+a.menu);if(s.length){s.data("mmenu");if(t.is("input, textarea"));else switch(n.keyCode){case 13:(t.is(".mm-toggle")||t.is(".mm-check"))&&t.trigger(r.click);break;case 9:t.is("."+a.tabend)&&!n.shiftKey&&(n.preventDefault(),e("."+a.trigger).focus());break;case 32:case 37:case 38:case 39:case 40:n.preventDefault()}}}),n&&l.$wndw.on(r.keydown+"-"+i,function(n){var t=e(n.target),s=t.closest("."+a.menu);if(s.length){var i=s.data("mmenu");if(t.is("input, textarea"))switch(n.keyCode){case 27:t.val("")}else switch(n.keyCode){case 8:var r=t.closest("."+a.panel).data(o.parent);r&&r.length&&i.openPanel(r.closest("."+a.panel));break;case 27:s.hasClass(a.offcanvas)&&i.close()}}})};var a,o,r,l,d="input, select, textarea, button, label, a[href]"}(jQuery),/*	
