!(function (e) {
    ...
    function (e, t, n) {
                ...
                return (
                    ...
                    (e.prototype.closeAllPanels = function (e) {
                        this.trigger('closeAllPanels:before'),
                            g(this.node.pnls, '.mm-listitem').forEach(function (
                                e
                            ) {
                    ...
                    (e.prototype._initObservers = function () {
                        var e = this;
                        (this.panelObserver = new MutationObserver(function (
                            ...
                            t.forEach(function (t) {
                                t.addedNodes.forEach(function (t) {
                                    t.matches(
                                        e.conf.panelNodetype.join(', ')
                                    ) && e._initListview(t);
                                });
                            });
                        })),
                            (this.listviewObserver = new MutationObserver(
                                function (t) {
                                    t.forEach(function (t) {
                                        t.addedNodes.forEach(function (t) {
                                            e._initListitem(t);
                            ...
                            (this.listitemObserver = new MutationObserver(
                                function (t) {
                                    t.forEach(function (t) {
                                        t.addedNodes.forEach(function (t) {
                                            t.matches(
                    ...
                    (e.prototype._initMenu = function () {
                        ...
                        var t = _(this.node.menu).filter(function (t) {
                            return t.matches(e.conf.panelNodetype.join(', '));
                        });
                        (this.node.pnls = b('div.mm-panels')),
                    ...
                    (e.prototype._initPanel = function (e) {
                        ...
                        if (
                            ...
                            return null;
                        if (((e.id = e.id || l()), e.matches('ul, ol'))) {
                            var n = b('div');
                            (n.id = e.id),
                                ...
                                e.dataset.mmParent &&
                                    ((n.dataset.mmParent = e.dataset.mmParent),
                                    delete e.dataset.mmParent),
                                e.before(n),
                                n.append(e),
                                (e = n);
                        }
                    ...
                    (e.prototype._initListitem = function (e) {
                        var t = this;
                    ...
                    (e.prototype._initSubPanel = function (e) {
                        var t = e.parentElement;
                        (e.matches('.' + this.conf.classNames.vertical) ||
                            !this.opts.slidingSubmenus) &&
                            t.classList.add('mm-listitem_vertical'),
                            (t.id = t.id || l()),
                            (e.id = e.id || l()),
                        ...
                        var n = _(t, '.mm-btn')[0];
                        n ||
                            ((n = b('a.mm-btn.mm-btn_next.mm-listitem__btn')),
                            _(t, 'a, span').forEach(function (e) {
                                e.matches('span')
        ...
        var O = function (e, t, n) {
                var i = t.split('.');
                (e[(t = 'mmEvent' + j(i[0]) + j(i[1]))] = e[t] || []),
                    e[t].push(n),
                    e.addEventListener(i[0], n);
            },
            D = function (e, t) {
                var n = t.split('.');
                (t = 'mmEvent' + j(n[0]) + j(n[1])),
                    (e[t] || []).forEach(function (t) {
                        e.removeEventListener(n[0], t);
                    });
            };
        (M.options.offCanvas = T), (M.configs.offCanvas = A);
        (M.prototype.open = function () {
            ...
            (M.prototype._openSetup = function () {
                ...
                this.closeAllOthers(),
                    (M.node.page.mmStyle =
                        M.node.page.getAttribute('style') || ''),
                    (function (e, t, n) {
                        var i = t.split('.');
                        (e[(t = 'mmEvent' + j(i[0]) + j(i[1]))] || []).forEach(
                            function (e) {
                                e(n || {});
                            }
                        );
        ...
        var I = function () {
                var e = this;
                D(document.body, 'keydown.tabguard'),
                    O(document.body, 'keydown.tabguard', function (t) {
                        9 == t.keyCode &&
        ...
        u(
            ...
            u(U, 'de'),
            u(W, 'ru'),
            (M.options.screenReader = B),
            (M.configs.screenReader = z);
        var Y = { fix: !0 };
        var F = 'ontouchstart' in window || !!navigator.msMaxTouchPoints || !1;
        M.options.scrollBugFix = Y;
        var X = { height: 'default' };
        M.options.autoHeight = X;
        var V = { close: !1, open: !1 };
        M.options.backButton = V;
        var Z = { add: !1, visible: { min: 1, max: 3 } };
        M.options.columns = Z;
        var G = { add: !1, addTo: 'panels', count: !1 };
        (M.options.counters = G),
            (M.configs.classNames.counters = { counter: 'Counter' });
        var K = { add: !1, addTo: 'panels' };
        (M.options.dividers = K), (M.configs.classNames.divider = 'Divider');
        var Q = { open: !1, node: null };
        var J = 'ontouchstart' in window || !!navigator.msMaxTouchPoints || !1,
            $ = { top: 0, right: 0, bottom: 0, left: 0 },
            ee = { start: 15, swipe: 15 },
            te = { x: ['Right', 'Left'], y: ['Down', 'Up'] },
            ne = 0,
            ie = 1,
            se = 2,
            ae = function (e, t) {
            ...
            me = function (e) {
                ...
                ce && (D(ce, 'dragStart'), D(ce, 'dragMove'), D(ce, 'dragEnd')),
                    (re = new oe((ce = e))),
                    s(),
                    (s = function () {}),
                    ce &&
                        (O(ce, 'dragStart', function (e) {
                        ...
                        O(ce, 'dragMove', function (e) {
                            if (e.detail.axis == n.axis && i) {
                                ...
                                switch (n.position) {
                                    case 'right':
                                    case 'bottom':
                                        t = Math.min(Math.max(t, -le), 0);
                                        break;
                                    default:
                                        t = Math.max(Math.min(t, le), 0);
                                }
        ...
        (M.options.dropdown = pe), (M.configs.dropdown = ue);
        var fe = { insertMethod: 'append', insertSelector: 'body' };
        (M.configs.fixedElements = fe),
        ...
        M.options.iconPanels = ve;
        var be = { enable: !1, enhance: !1 };
        M.options.keyboardNavigation = be;
        var ge = function (e) {
                var t = this;
                D(document.body, 'keydown.tabguard'),
                    D(document.body, 'focusin.tabguard'),
                    O(document.body, 'focusin.tabguard', function (e) {
                    ...
                    D(document.body, 'keydown.navigate'),
                    O(document.body, 'keydown.navigate', function (t) {
                        var n = t.target,
                            i = n.closest('.mm-menu');
                        if (i) {
                            i.mmApi;
            ...
            _e = { load: !1 };
        M.options.lazySubmenus = _e;
        var ye = [];
        var Le = { breadcrumbs: { separator: '/', removeFirst: !1 } };
        function we() {
            var e = this,
                t = this.opts.navbars;
            if (void 0 !== t) {
                ...
                t.length &&
                    (t.forEach(function (t) {
                        ...
                        'string' == typeof t.type &&
                            'function' == typeof (r = we.navbarTypes[t.type]) &&
                            r.call(e, i);
        ...
        (M.options.navbars = ye),
            (M.configs.navbars = Le),
                    ...
                    e.append(n),
                        ...
                        this.bind('initNavbar:after:sr-aria', function (e) {
                            g(e, '.mm-breadcrumbs a').forEach(function (e) {
                                N(e, 'owns', e.getAttribute('href').slice(1));
                            });
                        });
                },
                close: function (e) {
                    ...
                    e.append(n),
                        ...
                        this.bind('setPage:after:sr-text', function () {
                            (n.innerHTML = H(
                                ...
                                N(n, 'owns', n.getAttribute('href').slice(1));
                        });
                },
                prev: function (e) {
                    var t,
                    ...
                    e.append(a),
                        ...
                        this.bind('initNavbar:after:sr-aria', function (e) {
                            N(e.querySelector('.mm-navbar'), 'hidden', !0);
                        }),
                        this.bind('openPanel:start:sr-aria', function (e) {
                            N(a, 'hidden', a.matches('.mm-hidden')),
                                N(
                                    a,
                                    'owns',
        ...
        var Ee = { scroll: !1, update: !1 };
        var xe = { scrollOffset: 0, updateOffset: 50 };
        (M.options.pageScroll = Ee), (M.configs.pageScroll = xe);
        var Pe = {
            add: !1,
            addTo: 'panels',
            cancel: !1,
        ...
        var ke = { clear: !1, form: !1, input: !1, submit: !1 },
            Se = {
                Search: 'جستجو',
        ...
        u(
            ...
            u(Me, 'de'),
            u(Te, 'ru'),
            (M.options.searchfield = Pe),
            (M.configs.searchfield = ke);
        var Ae = function () {
                ...
                var n = b('ul');
                switch ((t.append(n), this.node.pnls.append(t), e.panel.fx)) {
                    case !1:
                        break;
                    case 'none':
            ...
            Ne = function (e) {
                ...
                (a.mmSearchfield = i),
                    n.panel.add &&
                        n.panel.splash &&
                        (D(a, 'focus.splash'),
                        O(a, 'focus.splash', function (e) {
                            t.openPanel(s);
                        })),
                    n.cancel &&
                        (D(a, 'focus.cancel'),
                        O(a, 'focus.cancel', function (e) {
                            o.classList.add('mm-searchfield__cancel-active');
                        }),
                        D(o, 'click.splash'),
                        O(o, 'click.splash', function (e) {
                            if (
                                (e.preventDefault(),
                                o.classList.remove(
        ...
        M.prototype.search = function (e, t) {
            ...
            var a = e.mmSearchfield,
                o = e.closest('.mm-searchfield'),
                r = g(o, '.mm-btn'),
                c = _(this.node.pnls, '.mm-panel_search')[0],
                l = a.panels,
                m = a.noresults,
                d = a.listitems,
                p = a.dividers;
            if (
                ...
                if (s.panel.add) {
                    ...
                    l.forEach(function (e) {
                        ...
                        (n = _(c, '.mm-listview')[0]).append.apply(n, f),
                        this.openPanel(c);
                } else
                    s.showSubPanels &&
                        l.forEach(function (e) {
                            var t = g(e, '.mm-listitem');
                ...
                r.forEach(function (e) {
                    ...
                    m.forEach(function (e) {
                        g(e, '.mm-panel__noresultsmsg').forEach(function (e) {
                            return e.classList[u ? 'add' : 'remove'](
                                'mm-hidden'
                            );
                        });
                    }),
                    s.panel.add &&
                        (s.panel.splash &&
                            g(c, '.mm-panel__content').forEach(function (e) {
                ...
                if (s.panel.splash)
                    ...
                    var h = _(this.node.pnls, '.mm-panel_opened-parent');
                    this.openPanel(h.slice(-1)[0]);
                }
            this.trigger('updateListview');
        };
        var je = { add: !1, addTo: 'panels' };
        M.options.sectionIndexer = je;
        var Oe = { current: !0, hover: !1, parent: !1 };
        M.options.setSelected = Oe;
        var De = {
            collapsed: {
                use: !1,
                blockMenu: !0,
        ...
        (M.addons = {
            offcanvas: function () {
                ...
                if (this.opts.offCanvas) {
                    ...
                    this.opts.offCanvas = a(t, M.options.offCanvas);
                    ...
                    this._api.push('open', 'close', 'setPage'),
                        ...
                        this.bind('setPage:after', function (e) {
                            M.node.blck &&
                                _(M.node.blck, 'a').forEach(function (t) {
                                    t.setAttribute('href', '#' + e.id);
                                });
                        }),
                        this.bind('open:start:sr-aria', function () {
                            N(e.node.menu, 'hidden', !1);
                        }),
                        this.bind('close:finish:sr-aria', function () {
                            N(e.node.menu, 'hidden', !0);
                        }),
            ...
            screenReader: function () {
                ...
                this.opts.screenReader = a(t, M.options.screenReader);
                ...
                t.aria &&
                    ...
                    this.bind('updateListview', function () {
                        g(e.node.pnls, '.mm-listitem').forEach(function (e) {
                            N(e, 'hidden', e.matches('.mm-hidden'));
                        });
                    }),
                    ...
                    t.text &&
                        ...
                        this.bind('initNavbar:after', function (e) {
                            ...
                            N(g(t, '.mm-navbar__title')[0], 'hidden', n);
                        })),
                    t.text &&
                        (this.bind('initAddons:after', function () {
            ...
            scrollBugFix: function () {
                var e = this;
                if (F && this.opts.offCanvas && this.opts.offCanvas.blockUI) {
                    var t = (function (e) {
                        return (
            ...
            autoHeight: function () {
                ...
                if (
                    ((this.opts.autoHeight = a(t, M.options.autoHeight)),
            ...
            backButton: function () {
                ...
                if (this.opts.offCanvas) {
                    ...
                    this.opts.backButton = a(t, M.options.backButton);
            ...
            columns: function () {
                ...
                if (((this.opts.columns = a(t, M.options.columns)), t.add)) {
                    ...
                    s.push.apply(s, i),
                        ...
                        this.bind('openPanel:start', function (s) {
                            var a = _(e.node.pnls, '.mm-panel_opened-parent')
                                .length;
            ...
            counters: function () {
                ...
                if (
                    ((this.opts.counters = a(t, M.options.counters)),
                    this.bind('initListview:after', function (t) {
            ...
            dividers: function () {
                ...
                (this.opts.dividers = a(t, M.options.dividers)),
                    this.bind('initListview:after', function (t) {
            ...
            drag: function () {
                ...
                if (this.opts.offCanvas) {
                    ...
                    (this.opts.drag = a(t, M.options.drag)),
                        t.open &&
            ...
            dropdown: function () {
                ...
                if (this.opts.offCanvas) {
                    ...
                    this.opts.dropdown = a(t, M.options.dropdown);
                    ...
                    if (t.drop) {
                        ...
                        this.bind('initMenu:after', function () {
                            ...
                            this.bind('open:start', function () {
                                (e.node.menu.mmStyle = e.node.menu.getAttribute(
                                    'style'
                                )),
            ...
            iconbar: function () {
                ...
                if (
                    ((this.opts.iconbar = a(n, M.options.iconbar)), n.use) &&
                    ...
                    var i = 'mm-menu_iconbar-' + n.position,
                        s = function () {
                            t.node.menu.classList.add(i), N(e, 'hidden', !1);
                        };
                    if (
            ...
            iconPanels: function () {
                ...
                this.opts.iconPanels = a(t, M.options.iconPanels);
                var n = !1;
                if (
                    ...
                    if (
                        ...
                        this.bind('initMenu:after', function () {
                            ...
                            this.bind('initBlocker:after', function () {
                                M.node.blck.append(s),
                                    _(M.node.blck, 'a')[0].classList.add(
                                        'mm-tabstart'
                                    );
                            });
                        var o =
                        ...
                        this.bind('open:finish', r),
                            ...
                            this.bind('initOpened:after:sr-aria', function () {
                                [e.node.menu, M.node.blck].forEach(function (
                                    e
                                ) {
            ...
            lazySubmenus: function () {
                ...
                (this.opts.lazySubmenus = a(t, M.options.lazySubmenus)),
                    t.load &&
            ...
            pageScroll: function () {
                ...
                this.opts.pageScroll = a(t, M.options.pageScroll);
                var n,
                            ...
                            if (r[s].offsetTop < n + i.updateOffset) {
                                if (c !== s) {
                                    ...
                                    (l = l.filter(function (e) {
                                        ...
                                        e.setSelected(l[0].parentElement);
                                }
                                break;
                            }
                    });
            ...
            searchfield: function () {
                ...
                this.opts.searchfield = a(t, M.options.searchfield);
                this.conf.searchfield;
                t.add &&
                    ...
                    this.bind('initPanel:after', function (n) {
                        ...
                        s.forEach(function (n) {
                            (n = Ce.call(e, n)), t.search && n && Ne.call(e, n);
                        }),
                            t.noResults && He.call(e, t.panel.add ? i : n);
                    }),
                    this.clck.push(function (t, n) {
                        if (n.inMenu && t.matches('.mm-searchfield__btn')) {
                            if (t.matches('.mm-btn_close')) {
                                var i = t.closest('.mm-searchfield'),
                                    s = g(i, 'input')[0];
                                return (s.value = ''), e.search(s), !0;
                            }
                            if (t.matches('.mm-btn_next'))
                                return (
                                    (i = t.closest('form')) && i.submit(), !0
                                );
                        }
                    }));
            },
            sectionIndexer: function () {
                ...
                (this.opts.sectionIndexer = a(t, M.options.sectionIndexer)),
                    t.add &&
            ...
            setSelected: function () {
                ...
                if (
                    ((this.opts.setSelected = a(t, M.options.setSelected)),
                    'detect' == t.current)
                ) {
                    var n = function (t) {
                        t = t.split('?')[0].split('#')[0];
            ...
            sidebar: function () {
                ...
                if (this.opts.offCanvas) {
                    ...
                    if (
                        ((this.opts.sidebar = a(t, M.options.sidebar)),
                        t.collapsed.use)
                    ) {
                        this.bind('initMenu:after', function () {
                            if (
        ...
        window && (window.Mmenu = M),
            (Ie = window.jQuery || window.Zepto || null) &&
                (Ie.fn.mmenu = function (e, t) {
                    var n = Ie();
                    return (
